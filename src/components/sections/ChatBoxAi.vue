      ...
      >
          ...
          <div class="flex items-center space-x-3">
            <div class="relative">
              <img src="/yui.png" alt="AI Avatar" class="w-10 h-10 rounded-full" /><span
                class="absolute bottom-0 right-0 w-3 h-3 animate-pulse bg-green-500 border-2 border-slate-900 rounded-full"
              ></span>
            </div>
            <div>
        ...
        <div class="p-4 bg-slate-900 rounded-b-xl flex-shrink-0">
          <form @submit.prevent="handleSendMessage" class="flex items-center space-x-2">
            ...
            >
              <i
                :class="chatStore.isLoading ? 'fas fa-spinner animate-spin' : 'fas fa-paper-plane'"
              ></i>
            </button>
          </form>
        </div>
