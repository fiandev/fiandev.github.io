...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzudItdVnZKimXLyzV8iuNwJim90SJmZnlctmTxonlsDK-nIn4_KxO3VLCNZDyYZFa9/exec';
...
watch(contactName, () => { if (errors.value.name) delete errors.value.name; });
watch(contactEmail, () => { if (errors.value.email) delete errors.value.email; });
watch(contactMessage, () => { if (errors.value.message) delete errors.value.message; });
...
<template>
    <section id="contact" class="py-20">
        ...
        <p class="text-center text-slate-400 mb-12 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">Have an
            interesting project or idea? I'd love to hear about it. Send me a message and let's bring your idea to
            life.</p>
        <form @submit.prevent="handleSubmit" class="max-w-xl mx-auto flex flex-col" data-aos="fade-up"
            data-aos-delay="200" novalidate>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label for="name" class="block text-slate-400 mb-2">Name</label>
                    <input type="text" placeholder="Your Name" v-model="contactName" id="name" name="name"
                ...
                <div>
                    ...
                    <input type="email" placeholder="Your Email" v-model="contactEmail" id="email" name="email"
            ...
            <div class="mb-6">
                ...
                <textarea placeholder="Your Message" id="message" v-model="contactMessage" name="message" rows="5"
            ...
            <div class="self-start">
                <button @click="handleSubmit" type="submit" :disabled="isSubmitting"
