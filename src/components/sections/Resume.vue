...
<template>
    <section id="experience" class="py-20">
        <h2 class="text-4xl font-bold text-center text-white mb-16" data-aos="fade-up">Experience & Education</h2>
        <div class="grid grid-cols-1 gap-12">
            <div data-aos="fade-up" data-aos-duration="800">
                <h3 class="text-2xl font-bold text-sky-400 mb-8 flex items-center justify-center gap-3"><i
                    ...
                    <div v-for="(item, index) in resumeStore.getExperience" :key="index"
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between space-x-2 mb-1">
                                <h4 class="font-bold text-white">{{ item.title }}</h4><time
                                    class="font-caveat font-medium text-sky-400">{{ item.period }}</time>
                            </div>
